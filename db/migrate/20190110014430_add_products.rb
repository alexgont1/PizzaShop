class AddProducts < ActiveRecord::Migration[5.2]
  def change
  	...
  	Product.create :title => 'Vegeterian', :description => 'Amazing Vegeterian pizza', :price => 400, :size => 30, :is_spicy => false, :is_veg => false, :is_best_offer => false, :path_to_image => '/images/veg.jpg'end
end
